...
class MNIST_DataLoader:
    ...
    def load(self):
        ...
        if name == "PCA_MNIST_5":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/PCA_MNIST_Hidden_5.pkl", "rb")
            )
        ...
        if name == "PCA_MNIST_10":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/PCA_MNIST_Hidden_10.pkl", "rb")
            )
        ...
        if name == "PCA_MNIST_20":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/PCA_MNIST_Hidden_20.pkl", "rb")
            )
        ...
        if name == "PCA_MNIST_30":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/PCA_MNIST_Hidden_30.pkl", "rb")
            )
        ...
        if name == "PCA_FMNIST_5":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/PCA_FMNIST_Hidden_5.pkl", "rb")
            )
        ...
        if name == "PCA_FMNIST_10":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/PCA_FMNIST_Hidden_10.pkl", "rb")
            )
        ...
        if name == "PCA_FMNIST_20":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/PCA_FMNIST_Hidden_20.pkl", "rb")
            )
        ...
        if name == "PCA_FMNIST_30":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/PCA_FMNIST_Hidden_30.pkl", "rb")
            )
        ...
        if name == "AE_MNIST_5":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/AE_MNIST_Hidden_5.pkl", "rb")
            )
        ...
        if name == "AE_MNIST_10":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/AE_MNIST_Hidden_10.pkl", "rb")
            )
        ...
        if name == "AE_MNIST_20":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/AE_MNIST_Hidden_20.pkl", "rb")
            )
        ...
        if name == "AE_MNIST_30":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/AE_MNIST_Hidden_30.pkl", "rb")
            )
        ...
        if name == "AE_FMNIST_5":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/AE_FMNIST_Hidden_5.pkl", "rb")
            )
        ...
        if name == "AE_FMNIST_10":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/AE_FMNIST_Hidden_10.pkl", "rb")
            )
        ...
        if name == "AE_FMNIST_20":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/AE_FMNIST_Hidden_20.pkl", "rb")
            )
        ...
        if name == "AE_FMNIST_30":
            ...
            Hidden = pickle.load(
                open(self.path + "/embedding/AE_FMNIST_Hidden_30.pkl", "rb")
            )
